...
class MageProfis_UrlIndexer_Helper_Category_Url_Rewrite
extends Mage_Catalog_Helper_Category_Url_Rewrite
{
    ...
    {
        if(Mage::getStoreConfigFlag('dev/index/optimize_categorie_leftjoin', $storeId))
        {
            $collection->joinTable(
                'urlindexer/url_rewrite_category',
    ...
    public function joinTableToCollection(Mage_Catalog_Model_Resource_Category_Flat_Collection $collection, $storeId)
    {
        if(Mage::getStoreConfigFlag('dev/index/optimize_categorie_leftjoin', $storeId))
        {
            $collection->getSelect()->joinLeft(
                array('url_rewrite' => $collection->getTable('urlindexer/url_rewrite_category')),
    ...
    public function joinTableToSelect(Varien_Db_Select $select, $storeId)
    {
        ...
        {
            $select->joinLeft(
                array('url_rewrite' => $this->_resource->getTableName('urlindexer/url_rewrite_category')),
